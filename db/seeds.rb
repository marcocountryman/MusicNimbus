...
image15 = open('https://music-nimbus-seeds.s3.amazonaws.com/astronaut-art.jpg')
song15.image_file.attach(io: image15, filename: 'astronaut-art.jpg')
sound15 = open('https://music-nimbus-seeds.s3.amazonaws.com/explosive-trap-beat-defekt-machine.mp3')
...
image16 = open('https://music-nimbus-seeds.s3.amazonaws.com/piano.jpg')
song16.image_file.attach(io: image16, filename: 'piano.jpg')
sound16 = open('https://music-nimbus-seeds.s3.amazonaws.com/suite-no-3-bach.mp3')
...
image17 = open('https://music-nimbus-seeds.s3.amazonaws.com/microphone-man.jpg')
song17.image_file.attach(io: image17, filename: 'astronaut-art.jpg')
sound17 = open('https://music-nimbus-seeds.s3.amazonaws.com/raise-your-glass-phantasticbeats.mp3')
...
image18 = open('https://music-nimbus-seeds.s3.amazonaws.com/saxophone.jpg')
song18.image_file.attach(io: image18, filename: 'saxophone.jpg')
sound18 = open('https://music-nimbus-seeds.s3.amazonaws.com/jazz-it-up-caffeine-creek-band.mp3')
...
image19 = open('https://music-nimbus-seeds.s3.amazonaws.com/moon.jpg')
song19.image_file.attach(io: image19, filename: 'moon.jpg')
sound19 = open('https://music-nimbus-seeds.s3.amazonaws.com/silent-wood.mp3')
...
image20 = open('https://music-nimbus-seeds.s3.amazonaws.com/last-art.jpg')
song20.image_file.attach(io: image20, filename: 'last-art.jpg')
sound20 = open('https://music-nimbus-seeds.s3.amazonaws.com/intro-music-blackbox.mp3')
...
image21 = open('https://music-nimbus-seeds.s3.amazonaws.com/violin.jpg')
song21.image_file.attach(io: image21, filename: 'violin.jpg')
sound21 = open('https://music-nimbus-seeds.s3.amazonaws.com/symphony-No-40-mozart.mp3')
...
image22 = open('https://music-nimbus-seeds.s3.amazonaws.com/car-art.jpg')
song22.image_file.attach(io: image22, filename: 'car-art.jpg')
sound22 = open('https://music-nimbus-seeds.s3.amazonaws.com/resolve-nbeatmusic.mp3')
...
image23 = open('https://music-nimbus-seeds.s3.amazonaws.com/sax-man.jpg')
song23.image_file.attach(io: image23, filename: 'sax-man.jpg')
sound23 = open('https://music-nimbus-seeds.s3.amazonaws.com/quando-juliush.mp3')
...
image24 = open('https://music-nimbus-seeds.s3.amazonaws.com/studying.jpg')
song24.image_file.attach(io: image24, filename: 'studying.jpg')
sound24 = open('https://music-nimbus-seeds.s3.amazonaws.com/travel-to-the-city-lesfm.mp3')
...
image25 = open('https://music-nimbus-seeds.s3.amazonaws.com/trap-art.jpg')
song25.image_file.attach(io: image25, filename: 'trap-art.jpg')
sound25 = open('https://music-nimbus-seeds.s3.amazonaws.com/knockout-blow.mp3')
